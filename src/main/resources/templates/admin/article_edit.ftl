...
<#if article.type=="SOLUTION">
	<#assign activeId = 2 />
<#elseif article.type=="CASE">
	<#assign activeId = 3 />
<#elseif article.type=="COMPANYNEWS">
	<#assign activeId = 5 />
<#elseif article.type=="INDUSTRYNEWS">
	<#assign activeId = 6 />
</#if>
<!DOCTYPE html>
<html lang="en">
										...
										<form  class="form-horizontal" action="add" method="post"/>
											...
											<fieldset>
												...
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="input-medium" id="name" name="title" value="${article.title}" />
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
												...
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="input-medium" id="orders" name="orders" value="${article.orders}" />
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
												...
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="input-large" id="image"  name="image" value="${article.image}" />
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
												...
												<#if article.type=="SOLUTION"||article.type=="CASE">
													<div class="control-group">											
														<label class="control-label" for="contentarea">内容：</label>
														<div class="controls">
															<textarea id="contentarea" name="content" class="editor" style="width: 100%;">${article.content}</textarea>
														</div> <!-- /controls -->				
													</div> <!-- /control-group -->
												<#elseif article.type=="COMPANYNEWS"||article.type=="INDUSTRYNEWS">
													<div class="control-group">											
														<label class="control-label" for="contentarea2">内容：</label>
														<div class="controls">
															<textarea id="contentarea2" name="content" style="width:400px;height:200px">${article.content}</textarea>
														</div> <!-- /controls -->				
													</div> <!-- /control-group -->
												</#if>			
