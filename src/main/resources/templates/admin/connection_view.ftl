										...
										<form  class="form-horizontal" action="add" method="post"/>
											<fieldset>
												...
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="input-medium" id="title" readonly name="title" value="${connection.title}" />
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
												...
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="input-medium" id="mail" readonly name="mail" value="${connection.mail}" />
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
												...
												<div class="control-group">											
													...
													<div class="controls">
														<textarea id="contentarea" name="content" style="width:400px;height:200px" readonly>${connection.content?trim}</textarea>
													</div> <!-- /controls -->				
												</div> <!-- /control-group -->
